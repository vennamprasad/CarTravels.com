...
import com.cartravels_new.utils.isValidPhoneNumber
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            R.id.next -> {
                ...
                val confirmpassword = rg_confirmpassword.text.toString().trim()
                ...
                if (confirmpassword.isEmpty()) {
                    rg_confirmpassword.error = "Confirm Password required"
                    rg_confirmpassword.requestFocus()
                    return
                }
                if (confirmpassword.length < 8) {
                    rg_confirmpassword.error = "Confirm Password length must be greater than 8 characters"
                    rg_confirmpassword.requestFocus()
                    return
                }
                if (!password.equals(confirmpassword)) {
                    rg_confirmpassword.error = "Password & Confirm Password must e same "
                    rg_confirmpassword.requestFocus()
                    return
                }
