...
import com.cartravels_new.screens.activities.LoginActivity
...
class OtpActivity : AppCompatActivity(), ConnectivityReceiver.ConnectivityReceiverListener {
	...
	private fun startSignWithExistingDetails() {
	...
	private fun updateUI(user: FirebaseUser?) {
		Tools.disableViews(progressBar)
		if (user != null) {
			val account=UserSignInData.setGoogleUserData(user)
				goToProfileScreen(account)
		}
	}
